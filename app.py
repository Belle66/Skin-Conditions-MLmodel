...
# 2. Load the Model using Legacy Keras
@st.cache_resource
def load_my_model():
    # Using keras.models (tf_keras) instead of tf.keras to handle version mismatch
    model = keras.models.load_model('skin_disease_model.h5', compile=False)
    return model
